 ...
 */
public final class OpenSslStaticX509KeyManagerFactory extends KeyManagerFactory {

    private final String password;

    public OpenSslStaticX509KeyManagerFactory(final KeyManagerFactory factory, String password) {
    ...
    // Return an OpenSslCachingKeyMaterialProvider for better performance when using OpenSSL.
    OpenSslKeyMaterialProvider provider() {
        return new OpenSslCachingKeyMaterialProvider(
                ReferenceCountedOpenSslContext.chooseX509KeyManager(getKeyManagers()), password);
    }
}
